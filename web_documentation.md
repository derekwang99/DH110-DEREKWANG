...
This project took quite a lot of independent research, especially when it came to the actual prototyping process. Despite this, I found the whole process to be quite interesting and meaningful. I found it very satisfying to see that each decision I made when it came to functionality or interface design was indeed motivated by a real concern for the user. Throughout the design process, I tried my best to distance myself from the user and avoid introducing my own biases that could compromise the goal of designing specifically for the user. For example, my personal design style is to introduce more modern pastel colors and fancy swiping interactions/menus. However, the low contrast of pastel color schemes and more complicated functions are not suitable for this project given the physical constraints of our users. It is through this project though that I realize that designing for accessibility helps everyone use a product better--everyone benefits from improved readability and guided product usage.
