...
| **#2: Match between system and the real world:** The design should speak the users' language. Use words, phrases, and concepts familiar to the user, rather than internal jargon. Follow real-world conventions, making information appear in a natural and logical order.   | **(3)** The "Print Waiting ..." is not a natural phrase people see, so it can be confusing to some.  | Instead of "Print Waiting ...", the Print button should simply be labeled as "Print". |
| 3      | Major usability problem: important to fix, so should be given high priority |
