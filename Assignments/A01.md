...
| **#4: Consistency and standards:** Users should not have to wonder whether different words, situations, or actions mean the same thing. Follow platform and industry conventions.| **(3)** The navigation bar changes frequently. Getting onto a new page means learning the new navigation, which is very taxing on the user. Users have to actively learn how to use the app. **(3)** A lot of the icons are crpytic and some are even mislabeled. The first 2 icons on the navigation abar are nearly uninterpreatble, and the last icon is colloquially recognized as a Profile icon, but instead serves to show a tutorial. **(3)** The Picture/Profile Picture can be easily changed by tapping the icon (a rather large icon too). Users often accidentally hit this icon which opens up the camera app. | The icons should be properly selected and should fit the common standard. A profile icon sohuld lead to the profile section. The navigation bar should be unchanging to avoid complexity. As for the Picture/Profile Picture function, the ability to change it should be indicated by a small X on the upper left corner of the icon. The X is a clear indication to get rid/change the profile picture. This way users will not accidentally hit it andopen the camera. 
