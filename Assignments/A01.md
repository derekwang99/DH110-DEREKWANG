...
| Heuristic & Description | Evaluation | Suggested Improvement
|--------|------------|-----------------|
| #1: Visibility of system status
The design should always keep users informed about what is going on, through appropriate feedback within a reasonable amount of time.      | Little to no issues, issues that arise are cosmetic | blahlblahblah |
| 2      | Minor usability problem: fixing this should be given low priority |
| 3      | Major usability problem: important to fix, so should be given high priority |
